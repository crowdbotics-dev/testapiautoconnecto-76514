...
## Project Structure
    ...
    ├── testapiautoconnecto_76514  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_76514`
...
2. Clone this repo and `cd testapiautoconnecto_76514`
